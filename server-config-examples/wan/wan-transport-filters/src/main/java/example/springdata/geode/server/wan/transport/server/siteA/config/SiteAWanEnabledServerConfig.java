package example.springdata.geode.server.wan.transport.server.siteA.config;

import example.springdata.geode.server.wan.transport.config.WanEnabledServerCommonConfig;
