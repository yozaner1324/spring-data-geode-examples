package example.springdata.geode.server.wan.substitution.server.siteA.config;

import example.springdata.geode.server.wan.substitution.config.WanEnabledServerCommonConfig;
