package example.springdata.geode.server.wan.event.server.siteA.config;

import example.springdata.geode.server.wan.event.config.WanEnabledServerCommonConfig;
