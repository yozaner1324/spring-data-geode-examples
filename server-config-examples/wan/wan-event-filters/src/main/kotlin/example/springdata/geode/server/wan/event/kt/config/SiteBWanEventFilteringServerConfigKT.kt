...
internal class SiteBWanEventFilteringServerConfigKT {
    @Bean
    ...
    @Bean
    @DependsOn("DiskStore")
    fun createGatewaySender(gemFireCache: GemFireCache, gatewayEventFilter: GatewayEventFilter) =
            GatewaySenderFactoryBean(gemFireCache as Cache).apply {
                ...
                setEventFilters(listOf(gatewayEventFilter))
                isPersistent = false
            }
}